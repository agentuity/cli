...
### Fixed
- Filepath issue: make sure we convert filepaths to localized path separator (windows!) ([#80](https://github.com/agentuity/cli/pull/80))

### Documentation
- Add CHANGELOG.md for v0.0.57 ([#79](https://github.com/agentuity/cli/pull/79))
